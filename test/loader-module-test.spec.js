...
describe('SKY UX Builder Webpack module loader', () => {
  ...
  let loader;
  beforeEach(() => {
    loader = require('../loader/sky-pages-module-test/index');
  });

  it('should call the SKY UX Builder module generator with includeRouteModule false', () => {
    ...
    expect(getSourceSpy).toHaveBeenCalledWith(expectedConfig);
  });
