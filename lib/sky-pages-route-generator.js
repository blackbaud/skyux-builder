...
function generateRoutes(skyAppConfig) {
  ...
  if (skyAppConfig.runtime.handle404) {
    const err = `<iframe src="https://host.nxt.blackbaud.com/errors/notfound" style="border:0;height:100vh;width:100%;" [title]="'builder_page_not_found_iframe_title' | skyAppResources"></iframe>`;
    entities.push({
