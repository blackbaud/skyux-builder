...
function getSource(skyAppConfig) {
  ...
  console.log('previous sky-pages-config', skyAppConfig);

  skyAppConfig.includeRouteModule = false;
...
`{
  ...
  console.log('includeRouteModule', skyAppConfig.includeRouteModule);

  if (skyAppConfig.includeRouteModule) {

    runtimeModuleImports.push('routing');

    // Is this not needed anymore?
    runtimeProviders.push('appRoutingProviders');
    // Is this changed to the SkyAppConfig one?
    runtimeProviders.push(`{
